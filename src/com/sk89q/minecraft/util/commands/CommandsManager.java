 ...
 *
 * <p>To mark a method as a command, use {@link com.sk89q.minecraft.util.commands.Command}. For nested commands,
 * see {@link com.sk89q.minecraft.util.commands.NestedCommand}. To handle permissions, use
...
public abstract class CommandsManager<T> {
    ...
    /**
     * Register an class that contains commands (denoted by {@link com.sk89q.minecraft.util.commands.Command}.
     ...
     * class will be registered to be called statically. Otherwise, new
     * instances will be created of the command classes and methods will
     * not be called statically. A List of {@link com.sk89q.minecraft.util.commands.Command} annotations from
     * registered commands is returned.
     *
     * @param cls
     * @return A List of {@link com.sk89q.minecraft.util.commands.Command} annotations from registered commands,
